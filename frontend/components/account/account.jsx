      ...
      <div className="account-page">
        <div className="account-top">
          ...
          <div className="account-cycle">
            You have <span>{currentUser.treatsLeft} MORE TREATS</span> left in your cycle.
          </div>
          <div className="account-icons">
            {treatType.map( (type, idx) => {
              return <img key={idx} src={type ? "https://res.cloudinary.com/mwojick/image/upload/v1529051209/ic-used.png" : "https://res.cloudinary.com/mwojick/image/upload/v1529051209/ic-unused.png"}></img>;
            } )}
          </div>
