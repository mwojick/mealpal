...
import TreatIndexItemContainer from "../treat_listing/treat_index_item_container";
...
class TreatIndex extends React.Component {
  ...
  render() {
    ...
    if (treats.length === 0) {
      return (
        <div className="treat-errors">
          <div className="treat-errors-text">
            <div className="treat-errors-sorry">Sorry, no treats found.</div>
            <div className="treat-errors-try">Please try the following:</div>
